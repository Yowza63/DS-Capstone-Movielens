...
# Project Overview
This project will build a predictive model to guess the rating a user will assign to a specific movie. We will start with gathering the MovieLens data, creating a training data set to fit our model, and a testing or validation data set to measure the effectiveness of the model. The predictive model will use machine learning techniques to fit the best model.
